export const messages = {
  en: {
    ...
    sources: {
      ...
      skipChunking: "Keep as single source",
      skipChunkingHint: "Don't split into sections - use the entire article as one piece",
      ...
      addWebsiteDescription: "Add a website URL to crawl all pages and use as content sources. Pages will be discovered, scored for relevance, and parsed automatically.",
      websiteUrl: "Website URL",
      websiteUrlPlaceholder: "https://example.com",
      websiteUrlHint: "Enter the root URL of the website to crawl",
      maxPages: "Max pages to crawl",
      stalenessDays: "Re-crawl after (days)",
      stalenessDaysHint: "Pages older than this will be re-scraped on the next crawl",
      filterPatterns: "Exclude URL patterns",
      filterPatternsHint: "One regex pattern per line to exclude matching URLs",
      addWebsiteError: "Failed to add website",
    ...
    // Persona / Personal Blog
    persona: {
      title: "Personal Blog",
      modeLabel: "Channel Mode",
      modeStandard: "Standard",
      modePersonalBlog: "Personal Blog",
      modeDescription: "Personal blog mode makes AI write as a real person with a consistent persona",
      nameLabel: "Persona Name",
      namePlaceholder: "e.g., Misha the Developer",
      descriptionLabel: "Persona Description",
      descriptionPlaceholder: "Describe the persona: who they are, how they talk, interests, backstory...",
      assetsTitle: "Reference Photos",
      assetsDescription: "Upload photos for visual context. AI will use descriptions to understand your world.",
      addPhoto: "Add Photo",
      assetLabelPlaceholder: "e.g., This is the author",
      assetDescriptionPlaceholder: "Describe what's in the photo...",
      storyArcsTitle: "Story Arcs",
      storyArcsDescription: "Plan narrative events for your blog. Active arcs get woven into generated posts.",
      addStoryArc: "Add Story Arc",
      arcTitleLabel: "Title",
      arcTitlePlaceholder: "e.g., Coffee shop discovery",
      arcDescriptionLabel: "Description",
      arcDescriptionPlaceholder: "What happens in detail...",
      arcActiveDateLabel: "Active Date",
      arcEndDateLabel: "End Date (optional)",
      arcStatusPending: "Pending",
      arcStatusActive: "Active",
      arcStatusUsed: "Used",
      arcStatusExpired: "Expired",
      noStoryArcs: "No story arcs yet",
      noAssets: "No reference photos yet",
      featureCardTitle: "Personal Blog",
      featureCardDescription: "Manage your persona, reference photos, and story arcs",
  ...
  ru: {
    ...
    sources: {
      ...
      skipChunking: "Сохранить как единый источник",
      skipChunkingHint: "Не разбивать на секции — использовать всю статью целиком",
      ...
      addWebsiteDescription: "Добавьте URL сайта для обхода всех страниц и использования в качестве источников контента. Страницы будут обнаружены, оценены по релевантности и автоматически обработаны.",
      websiteUrl: "URL сайта",
      websiteUrlPlaceholder: "https://example.com",
      websiteUrlHint: "Введите корневой URL сайта для обхода",
      maxPages: "Макс. страниц для обхода",
      stalenessDays: "Повторный обход через (дней)",
      stalenessDaysHint: "Страницы старше этого срока будут повторно обработаны при следующем обходе",
      filterPatterns: "Исключить URL по шаблонам",
      filterPatternsHint: "По одному regex-шаблону на строку для исключения совпадающих URL",
      addWebsiteError: "Не удалось добавить сайт",
      crawlStatus: "Статус обхода",
      crawlStatuses: {
        idle: "Ожидание",
        discovering: "Обнаружение страниц...",
        scoring: "Оценка релевантности...",
        scraping: "Обработка страниц...",
        completed: "Завершено",
        failed: "Ошибка",
      },
      pagesDiscovered: "страниц обнаружено",
      pagesScraped: "страниц обработано",
      reCrawl: "Повторный обход",
      fullReCrawl: "Полный обход",
      reCrawling: "Обход...",
      websitePages: "Страницы сайта",
    ...
    persona: {
      title: "Личный блог",
      modeLabel: "Режим канала",
      modeStandard: "Стандартный",
      modePersonalBlog: "Личный блог",
      modeDescription: "В режиме личного блога ИИ пишет от лица реального человека с последовательным персонажем",
      nameLabel: "Имя персонажа",
      namePlaceholder: "напр., Миша-разработчик",
      descriptionLabel: "Описание персонажа",
      descriptionPlaceholder: "Опишите персонажа: кто он, как говорит, интересы, предыстория...",
      assetsTitle: "Референсные фото",
      assetsDescription: "Загрузите фото для визуального контекста. ИИ будет использовать описания для понимания вашего мира.",
      addPhoto: "Добавить фото",
      assetLabelPlaceholder: "напр., Это автор блога",
      assetDescriptionPlaceholder: "Опишите, что на фото...",
      storyArcsTitle: "Сюжетные линии",
      storyArcsDescription: "Планируйте события для блога. Активные линии встраиваются в генерируемые посты.",
      addStoryArc: "Добавить линию",
      arcTitleLabel: "Название",
      arcTitlePlaceholder: "напр., Открытие кофейни",
      arcDescriptionLabel: "Описание",
      arcDescriptionPlaceholder: "Что происходит подробно...",
      arcActiveDateLabel: "Дата активации",
      arcEndDateLabel: "Дата окончания (опционально)",
      arcStatusPending: "Ожидает",
      arcStatusActive: "Активна",
      arcStatusUsed: "Использована",
      arcStatusExpired: "Истекла",
      noStoryArcs: "Сюжетных линий пока нет",
      noAssets: "Референсных фото пока нет",
      featureCardTitle: "Личный блог",
      featureCardDescription: "Управляйте персонажем, фото и сюжетными линиями",
      savePersona: "Сохранить персонажа",
      saving: "Сохранение...",
      saved: "Сохранено!",
    },
  },
