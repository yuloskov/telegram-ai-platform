export const messages = {
  en: {
    ...
    sources: {
      ...
      featureCardCta: "Browse Similar Channels",
      addSource: "Add Channel",
      noSources: "No similar channels yet",
      ...
      scrapeNow: "Refresh",
      scraping: "Refreshing...",
      scrapedContent: "Their Posts",
      noContent: "No posts fetched yet",
      noContentDescription: "Click Refresh to see their latest content",
      views: "views",
      forwards: "forwards",
      reactions: "reactions",
      usedBadge: "Inspired",
      posts: "posts",
      deleteSource: "Remove Channel",
      deleteConfirm: "Remove this channel from your inspiration list?",
  ...
  ru: {
    ...
    sources: {
      ...
      featureCardCta: "Смотреть похожие каналы",
      addSource: "Добавить канал",
      noSources: "Похожих каналов пока нет",
      ...
      scrapeNow: "Обновить",
      scraping: "Обновление...",
      scrapedContent: "Их посты",
      noContent: "Посты ещё не загружены",
      noContentDescription: "Нажмите Обновить, чтобы увидеть их последние посты",
      views: "просмотров",
      forwards: "репостов",
      reactions: "реакций",
      usedBadge: "Вдохновило",
      posts: "постов",
      deleteSource: "Удалить канал",
      deleteConfirm: "Удалить этот канал из списка вдохновения?",
