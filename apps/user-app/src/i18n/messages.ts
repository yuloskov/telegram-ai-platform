export const messages = {
  en: {
    ...
    sources: {
      ...
      description: "Channels to scrape for content inspiration",
      addSource: "Add Source",
      noSources: "No content sources yet",
      noSourcesDescription: "Add channels to scrape for content inspiration",
      sourceUsername: "Channel Username",
      sourceUsernamePlaceholder: "@channelname",
      sourceUsernameHint: "Enter the public channel username",
      lastScraped: "Last scraped",
      neverScraped: "Never scraped",
      scrapeNow: "Scrape Now",
      scraping: "Scraping...",
      scrapedContent: "Scraped Content",
      noContent: "No content scraped yet",
      noContentDescription: "Trigger a scrape to fetch content",
      views: "views",
      forwards: "forwards",
      reactions: "reactions",
      usedBadge: "Used",
      ...
      deleteConfirm: "Delete this source and all scraped content?",
      addSourceDescription: "Add a Telegram channel to scrape",
      scrapeTriggered: "Scrape job started",
      scrapeError: "Failed to trigger scrape",
    },
  ...
  ru: {
    ...
    sources: {
      ...
      description: "Каналы для сбора идей контента",
      addSource: "Добавить источник",
      noSources: "Источников пока нет",
      noSourcesDescription: "Добавьте каналы для сбора идей контента",
      sourceUsername: "Имя канала",
      sourceUsernamePlaceholder: "@channelname",
      sourceUsernameHint: "Введите публичное имя канала",
      lastScraped: "Последний сбор",
      neverScraped: "Ещё не собирался",
      scrapeNow: "Собрать сейчас",
      scraping: "Сбор...",
      scrapedContent: "Собранный контент",
      noContent: "Контент ещё не собран",
      noContentDescription: "Запустите сбор для получения контента",
      views: "просмотров",
      forwards: "репостов",
      reactions: "реакций",
      ...
      deleteConfirm: "Удалить этот источник и весь собранный контент?",
      addSourceDescription: "Добавить Telegram канал для сбора",
      scrapeTriggered: "Задача сбора запущена",
      scrapeError: "Не удалось запустить сбор",
    },
